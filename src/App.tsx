...
import { ControlsOnly } from './components/ControlsOnly/ControlsOnly';
import { PlayerOnly } from './components/PlayerOnly/PlayerOnly';
...
const App = ({
  ...
  const [moveToBeginningWhenEnded, setMoveToBeginningWhenEnded] = useState(true);
